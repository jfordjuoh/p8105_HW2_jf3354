...
ANSWER: Using the pols-month data, I created a dataframe called p_m, which has 822 observations and 9 variables which includes the years (ranging from 1947-2015), months, and president, which shows if the president was a democrat or republican(1=Democrat 0=Repubs).  
