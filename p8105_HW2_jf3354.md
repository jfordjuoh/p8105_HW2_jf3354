...
\#p\_m = read\_csv(“./fivethirtyeight\_dataset/pols\_month.csv”).
...
``` r
filter(pbn, childs_first_name == "OLIVIA")   
```
...
#we have to arrange it by rank(or count) and year (year should be a column)
